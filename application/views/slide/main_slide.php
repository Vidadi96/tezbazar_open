			...
			<div class="col-lg-12">
                ...
                <form method="POST" enctype="multipart/form-data" action="/slides/img_upload_main">
                  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
									<input type="hidden" name="slide_name" value="slide1">
                  <div class="form-group m-form__group row" style="display: none" id="new_img">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <button style="position: relative; top: -5px;" type="submit" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Daxil et</button>
                      </div>
                    </div>
  								</div>
                </form>
