				...
				<div class="m-portlet m-portlet--head-solid-bg m-portlet--head-sm" m-portlet="true" id="m_portlet_tools_2">
						...
						<div class="m-portlet__head-caption">
							<div class="m-portlet__head-title">
								...
								<div class="absolute_right">
									<form action="/reports/export_excel" method="POST">
					...
					<div class="m-portlet__body">
						<div class="m-section">
							<div class="m-section__content">
								...
								<!--begin: Search Form -->
								<form action="/reports/export_report" method="POST">
                    ...
                    <div class="col-lg-3">
                      ...
                      <select class="form-control" name="buyer">
                          ...
                          <option <?=$row->user_id==$provider_id?'selected':''; ?> value="<?=$row->user_id; ?>"><?=$row->lastname; ?></option>
												<?php endforeach; ?>
                      </select>
										</div>
                    <div class="col-lg-2">
