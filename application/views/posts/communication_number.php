...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
                ...
                <form action="/posts/communication_number" method="post">
                  <input type="hidden" name="<?=$this->security->get_csrf_token_name(); ?>" value="<?=$this->security->get_csrf_hash(); ?>">

                  <div class="col-lg-3">
  									<input type="text" name="number" value="<?=$number->number; ?>" class="form-control m-input" placeholder="">
  									<span class="m-form__help"><?=$this->langs->for_example2; ?>: <i>+994515545635, +994556553535</i></span>
  								</div>
