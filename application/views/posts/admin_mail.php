...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
                ...
                <form action="/posts/admin_mail" method="post">
                  <input type="hidden" name="<?=$this->security->get_csrf_token_name(); ?>" value="<?=$this->security->get_csrf_hash(); ?>">

                  <div class="col-lg-3">
  									<textarea type="text" name="mail" class="form-control m-input" placeholder=""><?=$mail->to_mail; ?></textarea>
  									<span class="m-form__help"><?=$this->langs->for_example2; ?>: <i>mailname@mail.ru;mailname@gmail.com</i></span>
  								</div>
