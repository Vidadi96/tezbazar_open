			...
			<div class="col-lg-12">
				...
				<div class="m-portlet m-portlet--head-solid-bg m-portlet--head-sm" m-portlet="true" id="m_portlet_tools_2">
					...
					<div class="m-portlet__body">
						...
						<!--end: Search Form -->
						<!--begin: Datatable -->
						<table delete_url="/product/delete_measure/" class="table table-bordered m-table" active_passive_url="/product/measure_set_active_passive/">
							<thead>
								<tr>
									<th>
										<?=$this->langs->measure_name; ?>
									</th>
									<th>
							...
							<tbody>
								<?php foreach ($list as $item) {
									...
									$btn_active_passive ='<button active_passive="'.$active_passive.'" id="'.$item->measure_id.'" type="button" data-container="body" data-skin="dark" data-toggle="m-popover" data-placement="right" data-content="'.$word.'" class="'.$class.' set_active_passive btn m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air"></button>';
									...
									<tr>
										...
										<td>
											<a href="/product/edit_measure/'.$item->measure_id.'" class="btn btn-primary btn-sm m-btn m-btn--icon m-btn--icon-only">
												<i class="fa fa-pencil-alt"></i>
											</button>
										</td>
										<td>
											<button href="#" class="btn btn-danger btn-sm m-btn m-btn--icon m-btn--icon-only delete" rel="'.$item->measure_id.'">
