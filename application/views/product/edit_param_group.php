					...
					<form method="post" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
						<div class="m-portlet__body">
							<div class="form-group m-form__group row">
								...
								<?php $i=3; foreach($langs as $lang):?>
								<div class="col-lg-3">
									<div class="form-group">
										<label><?=$this->langs->name2; ?> (<?=$lang->name;?>) <img style="max-width: 20px" src="/img/langs/<?=$lang->thumb;?>" style="margin-right: 5px" /></label>
										<input type="text" name="title-<?=$lang->lang_id;?>" class="form-control" id="name" value="<?=@$items[(array_search($lang->lang_id, array_column($items, 'lang_id')))]["param_group_title"];?>" />
									</div>
								</div>
								<?php	$i++; endforeach;?>
								<div class="col-lg-3">
								...
								<div class="col-lg-3">
									...
									<div class="m-radio-inline">
										<label class="m-radio m-radio--solid">
											<input type="radio" name="active" <?=($items[0]["active"]==1)?"checked":"";?> value="1">
											<?=$this->langs->active; ?>
											<span></span>
										</label>
										<label class="m-radio m-radio--solid">
