	...
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
					...
					<div class="m-portlet__body">
						<div class="m-section">
							<div class="m-section__content">
								...
								<!--begin: Search Form -->
								<form action="/product/show_in_main_page" method="POST">
                ...
                <input type="hidden" id="token" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
								<table class="table table-bordered m-table" active_passive_url="/product/show_unshow/">
									<thead>
										<tr>
											<th>
											...
											<th>
												<?=$this->langs->discount_percentage; ?>
											</th>
											<th>
												SKU
											</th>
