						...
						<div class="m-portlet__body">
							<div class="form-group m-form__group row">
								<div class="col-lg-3">
									...
									<input type="text" name="order_by" value="<?=$list[0]["order_by"];?>" class="form-control m-input" placeholder="">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" name="title-<?=$lang->lang_id;?>" class="form-control" id="name" value="<?=@$list[(array_search($lang->lang_id, array_column($list, 'lang_id')))]["title"];?>" />
									</div>
								</div>
								<?php
								if($i==3)
								...
								<div class="col-lg-3">
									...
									<div class="m-radio-inline">
										<label class="m-radio m-radio--solid">
											<input type="radio" name="active" <?=($list[0]["active"]==1)?"checked":"";?> value="1">
											<?=$this->langs->active; ?>
											<span></span>
										</label>
										<label class="m-radio m-radio--solid">
											<input type="radio" name="active" <?=($list[0]["active"]==1)?"":"checked";?> value="0">
											<?=$this->langs->passive; ?>
											<span></span>
										</label>
									</div>
