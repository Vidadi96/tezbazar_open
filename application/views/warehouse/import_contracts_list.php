...
<!-- END: Subheader -->
	<div class="m-content">
        ...
        <?php if(isset($status)): ?>
						...
						<div class="m-portlet__head-caption">
							<div class="m-portlet__head-title">
								...
								<h3 class="m-portlet__head-text">
									<?=$this->langs->new_import_contract; ?>
								</h3>
							</div>
						</div>
					</div>
                ...
                <form action="/warehouse/import_contracts_list" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group m-form__group row">
                    <div class="col-md-4 col-lg-3">
                      <div class="form-group">
                        ...
                        <input class="form-control m-input" disabled value="<?=$contract_number; ?>"/>
                      </div>
                    </div>

										<div class="col-md-4 col-lg-3">
                      <div class="form-group">
                        <label for="salesman"><?=$this->langs->provider; ?></label>
                    ...
                    <div class="col-md-4 col-lg-3">
                      <div class="form-group">
                        <label for="address"><?=$this->langs->address2; ?></label>
										...
										<div class="col-md-4 col-lg-3">
                      <div class="form-group">
                        <label for="deliveryman"><?=$this->langs->deliveryman; ?></label>
          ...
          <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
              <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                  <?=$this->langs->import_contract_list; ?>
                </h3>
              </div>
            </div>
          </div>
          <div class="m-portlet__body">
            <table delete_url="/warehouse/delete_import_contract/" class="table table-bordered m-table">
              <thead>
                <tr>
                  <th>#</th>
                  ...
                  <th>Voen</th>
                  <th><?=$this->langs->address2; ?></th>
                  <th><?=$this->langs->deliveryman; ?></th>
              ...
              <tbody>
                <?php $i=0; foreach($import_contracts_list as $row): $i++; ?>
                  <tr>
                    <td><?=$i; ?></td>
                    <td>
