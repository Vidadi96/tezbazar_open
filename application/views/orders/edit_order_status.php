							...
							<div class="form-group m-form__group row">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" name="title-<?=$lang->lang_id;?>" class="form-control" id="name" value="<?=@$items[(array_search($lang->lang_id, array_column($items, 'lang_id')))]["order_status_title"];?>" />
									</div>
								</div>
								<?php
								if($i==3)
