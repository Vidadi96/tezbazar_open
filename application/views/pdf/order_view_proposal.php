...
$html = '
  ...
  $html .= '
    ...
    $obj_pdf->Cell(32, 10, $this->langs->count, 'LTRB', 0, 'C', FALSE);
		$obj_pdf->Cell(32, 10, $this->langs->price, 'LTRB', 0, 'C', FALSE);
    $obj_pdf->Cell(30, 10, $this->langs->proposal, 'LTRB', 1, 'C', FALSE);
    ...
    if($textLength > 228)
      ...
      $rowheight = 14;
        ...
        $obj_pdf->Cell(32, $rowheight, $row->count, 'LBR', 0, 'C', FALSE);
				$obj_pdf->Cell(32, $rowheight, $row->ex_price." azn", 'LBR', 0, 'C', FALSE);
        $obj_pdf->Cell(30, $rowheight, $row->qiymet_teklifi." azn", 'LBR', 1, 'C', FALSE);
    }
